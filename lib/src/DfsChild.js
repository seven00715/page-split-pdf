...
class DfsChild extends PdfPage_1.default {
    ...
    getTableModuleInfo(ele, height) {
        const tbModuleInfo = Object.assign({ tbTopInfo: this.getEleHeight(ele, const_1.default.cardTableTopWraper), tbHeader: this.getEleHeight(ele, const_1.default.cardTableTBHeaderWraper), table: this.getEleHeight(ele, const_1.default.cardTableWraper), tbBomInfo: this.getEleHeight(ele, const_1.default.cardTableBomWraper), minHeight: 0, marginPadHeight: 0 }, this.setRowSpanMergeInfo(ele));
